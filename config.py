...
MENSAGEM_BEM_VINDO_DEFAULT = (
    "Olá {user}! 🎉\n\n"
    "És o nosso **{count}º membro** desta comunidade tuga. 🇵🇹\n\n"
    "Antes de começares a explorar o servidor:\n"
    "➡️ Lê as regras em {regras}\n"
    "➡️ **Clica no botão verde abaixo para te verificares** e desbloqueares todos os canais\n"
    "➡️ Escolhe os teus cargos no canal de auto-roles\n\n"
    "Se precisares de ajuda, abre um ticket em {tickets}. Boa estadia! 💪"
)
...
CATEGORIAS_TICKET_DEFAULT = [
    ...
    {
        "id": "denuncia",
        "nome": "Denúncia de Cheat/Bug",
        "emoji": "🐛",
        "descricao": "Queres denunciar um cheater ou reportar um bug do jogo?",
        "cor": 0xE74C3C,
        "placeholder": "Descreve o cheater ou bug que queres denunciar (com provas se possível)...",
    },
    {
        "id": "suporte_geral",
        "nome": "Suporte Geral",

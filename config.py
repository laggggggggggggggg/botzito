...
class GuildConfig:
    ...
    # Lista de membros autorizados a usar comandos do bot (além de admins)
    staff_autorizada: list = None
    ...
    def __post_init__(self) -> None:
        ...
        if self.staff_autorizada is None:
            self.staff_autorizada = []
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "staff_autorizada": self.staff_autorizada,
        }
    ...
    def from_dict(cls, d: dict) -> "GuildConfig":
        ...
        for k, v in d.items():
            ...
            elif k in ("categorias_ticket", "staff_autorizada"):

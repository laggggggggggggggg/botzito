...
class SetupModal(discord.ui.Modal):
    ...
    def __init__(self, cog: "SetupCog", guild: discord.Guild) -> None:
        ...
        self.nome = discord.ui.TextInput(
            ...
            default=cfg.nome_servidor if cfg.setup_completo else guild.name,
            max_length=80,
            required=True,
        )
        ...
        self.msg_bem_vindo = discord.ui.TextInput(
            label="Mensagem boas-vindas ({user}, {count}, {regras}, {tickets})",
        ...
        self.msg_ticket_panel = discord.ui.TextInput(
            label="Mensagem painel tickets ({regras})",
            placeholder="Deixa vazio para usar o template padrão...",
            style=discord.TextStyle.paragraph,
        ...
        self.msg_ticket_criado = discord.ui.TextInput(
            label="Mensagem dentro de cada ticket ({user}, {motivo})",
            placeholder="Deixa vazio para usar o template padrão...",
            style=discord.TextStyle.paragraph,
...
class SelecaoCanaisView(discord.ui.View):
    ...
    def __init__(self, cog: "SetupCog", guild: discord.Guild, user_id: int) -> None:
        ...
        canais_texto = list(guild.text_channels[:24])
